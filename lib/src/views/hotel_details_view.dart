...
class _HotelDetailsPageState extends State<HotelDetailsPage> {
  ...
  List _aminities = [
    ...
    {'icon': FontAwesomeIcons.swimmingPool, 'name': 'Gym'},
    {'icon': FontAwesomeIcons.swimmingPool, 'name': 'Heater'},
    {'icon': FontAwesomeIcons.swimmingPool, 'name': 'Elevator'},
    {'icon': FontAwesomeIcons.swimmingPool, 'name': ''}
  ];
  String description =
  ...
  Widget build(BuildContext context) {
    print("Build height ${_headerHeight}");
    return Scaffold(
        body: Stack(
          children: [
            GestureDetector(
              onTap: () {
                commonActions.shiftPage(context, ImagesViewPage());
              },
              child: AbsorbPointer(
                child: Container(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  DecoratedSliver(
                      ...
                      sliver: HotelListView(_loading, _scrollController))
                ],
              ),
            ),
          ],
